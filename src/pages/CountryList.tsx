    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Compare manufacturing readiness across African countries
        </p>
      </div>
      {error && (
          ...
          {countries.map((country) => {
            ...
            return (
              <div
                ...
                className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg transition-colors overflow-hidden flex flex-col justify-between border border-gray-100 dark:border-gray-700 hover:shadow-xl min-w-[320px] max-w-xs w-full"
              >
